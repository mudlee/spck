...
opengl_shader::opengl_shader(const char* vertex_shader, const char*fragment_shader) {
...
void opengl_shader::start() {
    glUseProgram(program_id);
}

void opengl_shader::stop() {
    glUseProgram(0);
}

GLuint opengl_shader::construct_shader(const char* shader, GLuint type) {
